...
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        var content = '<div class="box">' +
            '<h2><img src="assets/images/nameco-contact.png" alt="THIEN PHAT VINA"/></h2>' +
            '<div class="wrap-mapbox">' +
                '<p class="contact-1">Địa chỉ : 32 Đường 18, P. Bình Trị Đông B, Q. Bình Tân</p>' +
                '<p class="contact-2">Tel: +84 8 3825 1802</p>' +
                '<p class="contact-3"><a class="link-mail" href="mailto:info@suncake.vn">info@suncake.vn</a></p>' +
            '</div>' +
        '</div>';
