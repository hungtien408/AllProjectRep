    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        var content = '<div class="box">' +
            ...
            '<div class="wrap-mapbox">' +
                '<p class="contact-1">146 An Bình, Phường 7, Quận 5, Tp. HCM</p>' +
                '<p class="contact-2">(84.8) 8381 551</p>' +
                '<p class="contact-3">Email: <a href="mailto:contact@SaigonFruit.com">contact@SaigonFruit.com</a></p>' +
            '</div>' +
        '</div>';
